var language = localStorage.getItem('language',language) || "pt-BR"; //Guarda variável offline como cookie
...
function changeText(){ //Essa função esconde o texto em um idioma e exibe o de outro idioma
    ...
    localStorage.setItem('language', language); //Pega o idioma definido (pt-BR || en)
